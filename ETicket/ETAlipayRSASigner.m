...
@implementation ETAlipayRSASigner
...
- (NSString *)signString:(NSString *)string withRSA2:(BOOL)rsa2 {
    ...
    if (ret == 1) {
        NSString *base64String = [MF_Base64Codec base64StringFromData:[NSData dataWithBytes:sig length:sig_len]];
        signedString = [base64String URLEncodedString];
    }
