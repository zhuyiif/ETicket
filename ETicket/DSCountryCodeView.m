...
@interface DSCountryCodeView () <UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation DSCountryCodeView
...
+ (void)showWithCode:(NSString *)countryCode completeBlock:(void (^)(NSString *))completeBlock {
    ...
    for (UIView *view in parentView.subviews) {
        if ([view isKindOfClass:[DSCountryCodeView class]]) {
            return;
        }
    }
    DSCountryCodeView *countryCodeView = [[DSCountryCodeView alloc] initWithCountryCode:countryCode completeBlock:completeBlock];
