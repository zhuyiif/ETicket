...
@interface ETForgetPsdViewController ()
...
@property (nonatomic, strong) ETEditView *verifyPsdEditView;
@property (nonatomic, strong) UIView *contentView;
@property (nonatomic, strong) UILabel *errorLabel;
@property (nonatomic, strong) UIButton *submitButton;
@property (nonatomic, strong) ETAccountPresenter *presenter;

@end

@implementation ETForgetPsdViewController
