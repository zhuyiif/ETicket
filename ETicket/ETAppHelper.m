...
+ (void)configTheme {
    ...
    [[UIBarButtonItem appearance] setTitleTextAttributes:@{ NSFontAttributeName: [UIFont fontWithSize:16], NSForegroundColorAttributeName: [UIColor white2] } forState:UIControlStateNormal];
